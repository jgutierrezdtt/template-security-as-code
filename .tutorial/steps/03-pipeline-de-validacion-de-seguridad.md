...
Implementaras este control de POLICY de forma concreta sobre el archivo `policies/security.rego` y registraras evidencia tecnica en `.tutorial/evidence/step-03.json`.
...
{
  "step": 3,
  "title": "Pipeline de validacion de seguridad",
  "status": "completed",
