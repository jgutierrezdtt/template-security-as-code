...
Este paso introduce el reporting programático y debe dejar un cambio comprensible en `docs/security-as-code.md`.

## Que vas a cambiar y por que

En este paso vas a usar `docs/security-as-code.md` como base de reporting programático del programa. La idea es que el documento no solo describa controles, sino que pueda alimentar seguimiento sistemático: qué existe, cuánto cubre, qué excepciones siguen abiertas y qué debe hacerse en la siguiente iteración.
...
- Haz que `## Cobertura actual` y `## Excepciones activas` sean útiles para extraer estado del programa.
- Usa `## Siguiente iteracion` para enlazar reporting con decisión operativa, no solo con descripción.
...
- El documento ya parece una salida útil para seguimiento periódico del programa.
